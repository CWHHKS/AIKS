...
candidates = [
    "https://techcrunch.com/2024/09/04/safe-superintelligence-co-founded-by-openais-former-chief-scientist-raises-1b/",
    "https://www.reuters.com/technology/artificial-intelligence/ilya-sutskevers-ai-startup-ssi-raises-1-billion-2024-09-04/",
    "https://n.news.naver.com/mnews/article/092/0002344719?sid=105" # ZDNet Korea on Naver
]
...
for url in candidates:
    ...
    try:
        ...
        print(f" Exception for {url}: {e}", flush=True)
